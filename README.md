...
```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.3.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isAlmostEqual, isAlmostSameValue } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@deno/mod.js';
```
...
[@stdlib/complex/base/assert/is-almost-equal]: https://github.com/stdlib-js/complex-base-assert-is-almost-equal/tree/deno

[@stdlib/complex/base/assert/is-almost-same-value]: https://github.com/stdlib-js/complex-base-assert-is-almost-same-value/tree/deno
