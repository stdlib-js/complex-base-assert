...
```javascript
assert = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.3.1-umd/browser.js"></script>
```
...
[@stdlib/complex/base/assert/is-almost-equal]: https://github.com/stdlib-js/complex-base-assert-is-almost-equal/tree/umd

[@stdlib/complex/base/assert/is-almost-same-value]: https://github.com/stdlib-js/complex-base-assert-is-almost-same-value/tree/umd
