...
```javascript
import assert from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isEqual, isEqualf, isNotEqual, isNotEqualf, isSameValue, isSameValueZero, isSameValueZerof, isSameValuef } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.2.1-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.2.1-deno/mod.js';
...
[@stdlib/complex/base/assert/is-equal]: https://github.com/stdlib-js/complex-base-assert-is-equal/tree/deno

[@stdlib/complex/base/assert/is-equalf]: https://github.com/stdlib-js/complex-base-assert-is-equalf/tree/deno

[@stdlib/complex/base/assert/is-not-equal]: https://github.com/stdlib-js/complex-base-assert-is-not-equal/tree/deno

[@stdlib/complex/base/assert/is-not-equalf]: https://github.com/stdlib-js/complex-base-assert-is-not-equalf/tree/deno

[@stdlib/complex/base/assert/is-same-value-zero]: https://github.com/stdlib-js/complex-base-assert-is-same-value-zero/tree/deno

[@stdlib/complex/base/assert/is-same-value-zerof]: https://github.com/stdlib-js/complex-base-assert-is-same-value-zerof/tree/deno
