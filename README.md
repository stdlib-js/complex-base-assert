...
```javascript
import { isEqual, isEqualf, isNotEqual, isNotEqualf, isSameValue, isSameValueZero, isSameValuef } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@esm/index.mjs';
```
