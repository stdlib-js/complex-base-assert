...
```javascript
import { isAlmostEqual, isAlmostSameValue } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.3.1-deno/mod.js';
```
...
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-base-assert@v0.3.1-deno/mod.js';
